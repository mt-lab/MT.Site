...
var data = [
	{
		...
		body: [{
			tag: 'h1',
			content: 'Основываясь строго на документальных свидетельствах архива ИТМО,'
		},
		{
			tag: 'p',
			content: 'первое упоминание о прародительнице кафедры мехатроники содержится в приказе № 18 от 3.10.1930 по Учебному комбинату точной механики и оптики: “доцент Замыцкий Н.Н. назначен с 1.10.1930 заместителем заведующего кафедрой детали машин Института точной механики и оптики'
		}],
	...
	},
	{
		...
		body: [{
			tag: 'h1',
			content: "Первое собрание инициативной группы"
		},
		{
			tag: 'p',
